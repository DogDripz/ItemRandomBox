...
public class Menu3GUI extends GUI {
    public Menu3GUI(Player p) {
    ...
    protected void init() {
        Stream.iterate(0, i->i+1)
                .limit(9*5).forEach(integer -> setItem(" ", null, Material.STAINED_GLASS_PANE,  GUI.CYAN, 1, integer, "배경", false));
